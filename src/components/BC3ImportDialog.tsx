...
import { Upload, FileArrowDown, Globe, CheckCircle, Warning, Spinner, Database, TrendUp, Package } from '@phosphor-icons/react'
...
export function BC3ImportDialog({ trigger }: BC3ImportDialogProps) {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-6xl max-h-[95vh] overflow-hidden flex flex-col">
        ...
        <Tabs defaultValue="file" className="flex-1 flex flex-col">
          ...
          <TabsContent value="file" className="space-y-4 flex-1 overflow-auto">
            {!preview ? (
          ...
          <TabsContent value="online" className="space-y-4 flex-1 overflow-auto">
            <div className="space-y-4">
              <div className="space-y-2">
